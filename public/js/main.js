...
const currDay = document.getElementById('today_date')
...
const getInfo = async (event) => {
    ...
    if (cityVal === "") {
        ...
        try {
            ...
            let url = `https://api.openweathermap.org/data/2.5/weather?q=${cityVal}&appid=8f3da669dccb9035b848d05f0eeacb0f`
